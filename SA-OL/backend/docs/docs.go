    ...
    "definitions": {
        ...
        "ent.Foodmenu": {
            ...
            "properties": {
                ...
                "groupid": {
                    "description": "Groupid holds the value of the \"groupid\" field.",
                    "type": "integer"
                },
                "id": {
                    "description": "ID of the ent.",
                ...
                "menuing": {
                    "description": "Menuing holds the value of the \"menuing\" field.",
                    "type": "string"
                },
                "name": {
                ...
                "typeid": {
                    "description": "Typeid holds the value of the \"typeid\" field.",
                    "type": "integer"
                }
            }
        },
        "ent.FoodmenuEdges": {
            ...
            "properties": {
                "eatinghistorys": {
                    "description": "Eatinghistorys holds the value of the eatinghistorys edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Eatinghistory"
                    }
        ...
        "ent.Mealplan": {
            ...
            "properties": {
                ...
                "food_id": {
                    "description": "FoodID holds the value of the \"food_id\" field.",
                    "type": "integer"
                },
                "id": {
                    "description": "ID of the ent.",
                ...
                "meal_id": {
                    "description": "MealID holds the value of the \"meal_id\" field.",
                    "type": "integer"
                }
            }
        },
        ...
        "ent.Taste": {
            ...
            "properties": {
                ...
                "taste": {
                    "description": "Taste holds the value of the \"taste\" field.",
                    "type": "string"
                }
            }
        },
        ...
        "ent.UserEdges": {
            ...
            "properties": {
                ...
                "foodmenus": {
                    "description": "Foodmenus holds the value of the foodmenus edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Foodmenu"
                    }
