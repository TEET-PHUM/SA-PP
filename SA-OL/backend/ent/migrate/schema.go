...
var (
	...
	EatinghistoriesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:  "eatinghistories_foodmenus_eatinghistorys",
			...
			{
				Symbol:  "eatinghistories_mealplans_eatinghistorys",
			...
			{
				Symbol:  "eatinghistories_tastes_eatinghistorys",
			...
			{
				Symbol:  "eatinghistories_users_eatinghistorys",
	...
	FoodmenusColumns = []*schema.Column{
		...
		{Name: "menuing", Type: field.TypeString, Unique: true},
		{Name: "addedtime", Type: field.TypeString, Unique: true},
		{Name: "groupid", Type: field.TypeInt, Unique: true},
		{Name: "typeid", Type: field.TypeInt, Unique: true},
		{Name: "calories", Type: field.TypeInt, Unique: true},
	...
	FoodmenusTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:  "foodmenus_users_foodmenus",
				Columns: []*schema.Column{FoodmenusColumns[7]},
	...
	MealplansColumns = []*schema.Column{
		...
		{Name: "food_id", Type: field.TypeInt, Unique: true},
		{Name: "meal_id", Type: field.TypeInt, Unique: true},
		{Name: "owner_id", Type: field.TypeInt, Nullable: true},
	}
	...
	TastesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "taste", Type: field.TypeString, Unique: true},
	}
