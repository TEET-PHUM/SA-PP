...
// HasFoodmenus applies the HasEdge predicate on the "foodmenus" edge.
func HasFoodmenus() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FoodmenusTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FoodmenusTable, FoodmenusColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFoodmenusWith applies the HasEdge predicate on the "foodmenus" edge with a given conditions (other predicates).
func HasFoodmenusWith(preds ...predicate.Foodmenu) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FoodmenusInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FoodmenusTable, FoodmenusColumn),
		)
...
func HasEatinghistorys() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEatinghistorysWith(preds ...predicate.Eatinghistory) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
