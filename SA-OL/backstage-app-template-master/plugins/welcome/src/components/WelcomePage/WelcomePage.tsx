           ...
           <Grid container spacing={3}>
             ...
             <Grid item xs={9}>
               <FormControl variant="outlined" className={classes.formControl}>
                 <InputLabel id="mealplan_id-label">เลือกมื้ออาหาร</InputLabel>
                <Select
             ...
             <Grid item xs={9}>
               <FormControl variant="outlined" className={classes.formControl}>
                 <InputLabel id="foodmenu_id-label">เลือกรายการอาหาร</InputLabel>
                <Select
             ...
             <Grid item xs={9}>
               <FormControl variant="outlined" className={classes.formControl}>
                 <InputLabel id="taste_id-label">เลือกความพึงพอใจ</InputLabel>
                <Select
               ...
               >
                 {tastes.map((item:EntTaste)=>
                   <MenuItem value={item.id}>{item.taste}</MenuItem>)}
                  </Select>
               </FormControl>
             </Grid>
